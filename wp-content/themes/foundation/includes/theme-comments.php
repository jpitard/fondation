    	...
    	<a name="comment-<?php comment_ID() ?>"></a>
      	...
      	<div class="comment-container">
            ...
            <?php } ?>            
	      	...
	      	<div class="comment-head">
                ...
                <div class="comment-meta">        
    	            <span class="date"><?php echo get_comment_date($GLOBALS['meddate']) ?> <?php _e('at', 'nonprofitthemes'); ?> <?php echo get_comment_time(); ?></span>
	                <span class="perma"><a href="<?php echo get_comment_link(); ?>" title="<?php _e('Direct link to this comment', 'nonprofitthemes'); ?>">#</a></span>
			...
			<?php if ($comment->comment_approved == '0') { ?>
                <p class='unapproved'><?php _e('Your comment is awaiting moderation.', 'nonprofitthemes'); ?></p>
            <?php } ?>
...
function list_pings($comment, $args, $depth) {
	...
	<li id="comment-<?php comment_ID(); ?>">
		...
		<span class="date"><?php echo get_comment_date($GLOBALS['meddate']) ?></span>
